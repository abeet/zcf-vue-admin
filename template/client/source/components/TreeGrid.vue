<template>
  <el-table ref="dataTable" class="tree-grid-table" :data="tableData" :strict="strict" :show-summary="isShowSummary" :row-style="showTr" @selection-change="onSelectionChange" @cell-click="cellClick" :data-read-url="dataReadUrl" :draggable="draggable" @after-sort="afterTableSort" :auto-get-data="autoGetData">
